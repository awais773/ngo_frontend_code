        ...
        <>
         ...
         {docNavbarOpen && (
          <div className="fixed top-0 left-0 w-full h-full bg-black/50 z-40" onClick={() => setDocNavbarOpen(false)} />
            ...
            <h3 className=" text-black text-2xl mt-4 sm:mt-20 lg:mt-4 font-semibold mb-6 dark:text-white" >Package Versions</h3>
              ...
              <div className="w-full flex justify-between lg:gap-0 gap-6 lg:flex-nowrap flex-wrap p-6 rounded-md border border-border dark:border-dark_border">
                {
                    PackageVersions && PackageVersions.map((item)=>{
                        return(
                            <div key={item.id} className="lg:w-1/5 text-center  lg:border-e lg:last:border-e-0 border-border dark:border-dark_border">
                            <Image src={item.img} alt="npm-package" width={40} height={40} className=" mx-auto w-10 h-10 " />
